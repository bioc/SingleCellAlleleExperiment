...
Three optional functionalities can be toggled on or off during read in:
 ...
 - Computation of additional gene symbols in case the raw data only contains Ensemble gene identifiers. Use `gene_symbols=TRUE/FALSE` to toggle on or off accordingly. **Turned off by default**. Uses the org.HS package.
